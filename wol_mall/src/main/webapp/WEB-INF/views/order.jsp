...
<input type="radio" id="bank" name="payment" value="men" checked="checked" onchange="bank_select()">무통장입금
 <select class="bank_select">
			...
			<option value="nh">농협 010-7225-0852(예금주:서월성)</option>
			<option value="sh">신한은행 010-7225-0852(예금주:서월성)</option>
			<option value="ki">기업은행 010-7225-0852(예금주:서월성)</option>
		</select><td>
...
<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
   ...
   function card_select(){ 
	...
	function check_form(){
		...
		var bank_select = $(".bank_select option:selected").val();
		if(address==""){
			alert("주소를 입력해주세요")
			return false;
			}
