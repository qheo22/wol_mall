    ...
    <div class="container cont_wrap">
        ...
        <section class="form-row form_box">
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="input_postCode"
                           onclick="getPostCode()" placeholder="">
                </div>
                <div class="col-sm-2">
                    <button type="text" class="form-control" id="" placeholder="필수"
                            onclick="getPostCode()">우편주소
                    </button>
                </div>
            </div>
            ...
            <div class="form-group row mb-2">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="input_address" placeholder=""
                           onclick="getPostCode()">
                </div>
            </div>
            <div class="form-group row mb-2">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="3" id="input_message"
                              placeholder="배송 시 요청사항"></textarea>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function requestOrderComplete() {
            ...
            for (let i = 0; i < $(".product_list").children("li").length; i++) {
                ...
                formData.append("goodsImgUrl", $(".product_list").find(".imgClass")[i].currentSrc);
            }
