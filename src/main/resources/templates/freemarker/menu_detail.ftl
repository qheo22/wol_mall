                ...
                <div class="options_mbox">
                    ...
                    <div class="options">
                        ...
                        <div class="select_wrap mb-3 row">
                            ...
                            <select class="col-md-7 col-sm-7" id="inputGroupSelect02"
                                    name="sizeSelector">
                    ...
                    <div class="total_products">
                        ...
                        <div class="total_price" style="display: none">
                            ...
                            <span class="price"><strong
                                        class="goods_total_price">176,000</strong><em>원</em></span>
                        </div>
                    </div>
            ...
            if (localStorage.length === 0) {
                for (let i = 0; i < $(".total_list").children("li").length; i++) {
                    let item = {
                        ...
                        "goodsPrice": $(".sale").children("em").text(),
                        "goodsName": $(".name").text(),
                        "size": $(".total_list").find(".option_prod .size")[i].innerText,
                        "color": $(".total_list").find(".option_prod .color")[i].innerText,
                        "itemCount": $(".total_list").find(".option_num ")[i].value,
                        "itemPrice": $(".total_list").find(".option_price strong")[i].innerText,
                    }
                ...
                for (let i = 0; i < $(".total_list").children("li").length; i++) {
                    ...
                    let stringJSON = JSON.stringify(item)
                    localStorage.setItem("cartItem_" + index, stringJSON);
                }
                if (confirm("장바구니로 이동하시겠습니까??") == true) {
                    location.href = "cart";
                } else {
